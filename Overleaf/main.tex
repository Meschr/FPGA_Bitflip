...
%\usepackage[latin2]{inputenc} % danish letters apparently don't work when using latin2
...
\title{EXERCISE 2 (Asynchronous FIFO)} % to reference as \title, dont use \maketitle
...
\input{sources/mac_learning}
\newpage

\input{sources/4_VOQ}
\newpage

\input{sources/5_round_robin}
\newpage

\input{sources/6_crossbar_switch}
\newpage

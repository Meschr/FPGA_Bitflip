...
architecture sim of tb_voq_fifo is
    ...
    -- Kleiner FIFO fÃ¼r schnellere Simulation
...
begin
    ...
    begin
        ...
        -----------------------------------------------------------------------
        -- TEST 4: Frame auslesen und Daten prÃ¼fen
        -----------------------------------------------------------------------
        report "TEST 4: Frame auslesen...";

        -- Erste Lesung: rd_en setzen, Daten kommen einen Takt spÃ¤ter (BRAM)
        rd_en <= '1';
        wait until rising_edge(clk);
        ...
        -- AufrÃ¤umen: restlichen Frame auslesen (E1+EOF, 1 Byte)
        -- Nur 1 Takt rd_en, dann 1 Takt warten damit rd_valid die EOF-Auswertung abschlieÃt
        rd_en <= '1';
        wait for CLK_PERIOD;
        rd_en <= '0';
        wait for CLK_PERIOD;
        ...
        -----------------------------------------------------------------------
        -- TEST 7: Full-Signal (FIFO mit DEPTH=32 fÃ¼llen)
        -----------------------------------------------------------------------
